package com.example.redistest.demo.RedisTest;
...
public class Redistest implements Serializable {
        ...
        /*
        * redis数据类型数据类型存取（相同的key 第二次赋值将会将上一次值覆盖）
        * */
        @Test
        public void StringTets() {
        //1、通过redisTemplate设置值
        redisTemplate.boundValueOps("StringKey1").set("StringValue123");
        ...
        * */
        ...
        //是否包含某个key
        System.out.println("是否包含某个key"+redisTemplate.boundHashOps("HashKey").hasKey("wdwdwd"));
      ...
      /*  ArrayList<String> list = new ArrayList<>();
        ...
        List listKey1 = redisTemplate.boundListOps("listkey").range(0, 2);
        ...
        System.out.println("listKey1"+listKey1);
       ...
       redisTemplate.boundListOps("listkey").set(2L, "listLeftValue3");
        ...
        System.out.println("listKey4"+listKey4);
